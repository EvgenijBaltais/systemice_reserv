! function($) {
    window.tildaBrowserLang = window.navigator.userLanguage || window.navigator.language, window.tildaBrowserLang = window.tildaBrowserLang.toUpperCase(), -1 != window.tildaBrowserLang.indexOf("RU") ? window.tildaBrowserLang = "RU" : window.tildaBrowserLang = "EN", window.tildaForm = {
        ...
        window.tildaForm.captchaCallback = function(e) {
            ...
            var t = [],
                r = !0;
            return e.find(".js-tilda-rule").each(function() {
                var e, a, s = $(this).data("tilda-req") || 0,
            ...
            r || (r = ".blockinput");
            for (var a, s, i, n, o = window.tildaForm.arValidateErrors[window.tildaBrowserLang] || {}, l = "", d = 0; d < t.length; d++)
                if (t[d] && t[d].obj) {
                    if (0 == d && "none" == t[d].obj) {
            ...
            if (window.tcart = {
                ...
                if ("form" == arNext.type) {
                    ...
                    var key = "",
                        val = "";
                    html = '<form id="js-tilda-payment-formid" action="' + arNext.value.action + '" method="post"  style="position:absolue;opacity:0;width: 1px; height: 1px; left: -5000px;">', arNext.value.action = "";
                    ...
                    r && r.id && $.ajax({
                        ...
                        success: function(r) {
                            var a = "/tilda/" + e.attr("id") + "/payment/",
                                ...
                                i = t.amount,
                                n = t.description;
                            window.Tilda && "function" == typeof Tilda.sendEventToStatistics && Tilda.sendEventToStatistics(a, s, n, i), t.successurl > "" && window.setTimeout(function() {
                            ...
                            window.tcart = {
                                ...
                                system: "",
                                products: []
                            }, window.tildaForm.successEnd(e, t.successurl, o), e.trigger("tildaform:aftersuccess")
                        },
                        fail: function() {},
                        timeout: 15e3
                    })
            ...
            if (!0 !== window.cloudpaymentsapiiscalled) {
                var e = document.createElement("script");
                e.type = "text/javascript", e.src = "https://widget.cloudpayments.ru/bundles/cloudpayments", document.body.appendChild(e), window.cloudpaymentsapiiscalled = !0
            }
            ...
            var r = t.currency,
                a = t.language;
            if (a || (a = "RUB" == r || "BYR" == r ? "ru-RU" : "en-US"), !window.cloudpaymentshandler) {
            ...
            var s = {};
            s.projectid = t.projectid, t.cloudPayments && (t.cloudPayments.recurrent || t.cloudPayments.customerReceipt) && (s.cloudPayments = t.cloudPayments);
            var i = e.closest(".t-popup_show");
            return i && 0 != i.length || (i = e.closest(".t706__cartwin_showed")), i.data("old-z-index", i.css("z-index")), i.css("z-index", "auto"), window.cloudpaymentshandler.charge({
                publicId: t.publicId,
                description: t.description,
                ...
                i.css({
                    "z-index": i.data("old-z-index")
                });
                var a = "/tilda/" + e.attr("id") + "/payment/",
                    s = "Pay order in form " + e.attr("id"),
                    n = t.amount,
                    o = t.description;
                window.Tilda && "function" == typeof Tilda.sendEventToStatistics && Tilda.sendEventToStatistics(a, s, o, n), t.successurl > "" && window.setTimeout(function() {
                    window.location.href = t.successurl
                }, 300), e.data("successmessage") > "" ? e.find(".js-successbox").html(e.data("successmessage")) : e.find(".js-successbox").html(""), e.data("successmessage", "");
                var l = e.data("success-callback");
                window.tcart = {
                    amount: 0,
                    currency: "",
                    system: "",
                    products: []
                }, window.tildaForm.successEnd(e, t.successurl, l), e.trigger("tildaform:aftersuccess")
            }, function(r, a) {
                i.css({
                    "z-index": i.data("old-z-index")
                }), e.find(".js-successbox").hide(), e.data("successmessage") > "" ? e.find(".js-successbox").html(e.data("successmessage")) : e.find(".js-successbox").html(""), e.data("successmessage", ""), t.failureurl > "" && (window.location.href = t.failureurl)
            }), !1
                    ...
                    success: function(json) {
                        ...
                        if (btnformsubmit.removeClass("t-btn_sending"), btnformsubmit.data("form-sending-status", "0"), btnformsubmit.data("submitform", ""), json && json.error) {
                            ...
                            var virtPage = "/tilda/" + $jform.attr("id") + "/submitted/",
                                ...
                                virtPrice = 0,
                                virtProduct = "";
                            if (window.Tilda && "function" == typeof Tilda.sendEventToStatistics ? ($jform.find(".js-tilda-price").length > 0 && (virtPrice = $jform.find(".js-tilda-price").val(), virtProduct = "Order " + formres.orderid), Tilda.sendEventToStatistics(virtPage, virtTitle, "", virtPrice), window.dataLayer && window.dataLayer.push({
                                    ...
                                    event: "submit_" + $jform.attr("id")
                                })), $jform.trigger("tildaform:aftersuccess"), formsendedcallback && formsendedcallback.length > 0 && eval(formsendedcallback + "($jform);"), json && json.next && json.next.type > "") {
            ...
            return "y" == $jform.data("is-formajax") ? ($.ajax({
                ...
                success: function(html) {
                    ...
                    window.Tilda && "function" == typeof Tilda.sendEventToStatistics ? window.Tilda.sendEventToStatistics(virtPage, virtTitle, "", 0) : ("undefined" != typeof ga && "tilda" != window.mainTracker && ga("send", {
                        ...
                        window.location.href = successurl
                    }, 500), $jform.trigger("tildaform:aftersuccess")

                    /* Добавление цели на отправку формы счетчика яндекс метрики */
                    yaCounter44825506.reachGoal('get-price');
                    /* Добавление цели на отправку формы счетчика яндекс метрики */
            ...
            if ($(this).attr("data-tilda-captchakey") > "") {
                ...
                var e = $(this).attr("id");
                0 == $("#" + e + "recaptcha").length && $(this).append('<div id="' + e + 'recaptcha" class="g-recaptcha" data-sitekey="' + $(this).attr("data-tilda-captchakey") + '" data-callback="window.tildaForm.captchaCallback" data-size="invisible"></div>')
        ...
        $jallforms.length > 0 && $jallforms.each(function() {
            ...
            if (t.addClass("t-btn_sending"), t.data("form-sending-status", "1"), t.data("submitform", r), window.tildaForm.hideErrors(r), a = window.tildaForm.validate(r), window.tildaForm.showErrors(r, a)) return t.removeClass("t-btn_sending"), t.data("form-sending-status", "0"), t.data("submitform", ""), !1;
            ...
            if (0 == r.find(".js-formaction-services").length && 1 != s && "" == i) {
                ...
                return o && 0 != o.length || (n.append('<p class="js-rule-error-all">' + json.error + "</p>"), o = n.find(".js-rule-error-all")), o.html("Please set reciever in block with forms").show(), n.show(), r.addClass("js-send-form-error"), t.removeClass("t-btn_sending"), t.data("form-sending-status", "0"), t.data("submitform", ""), r.trigger("tildaform:aftererror"), !1
            }
            if (r.find(".g-recaptcha").length > 0 && grecaptcha) {
                ...
                var l = r.data("tilda-captcha-clientid");
                if (void 0 === l || "" === l) {
                    var d = {
                        size: "invisible",
                    ...
                    l = grecaptcha.render(r.attr("id") + "recaptcha", d), r.data("tilda-captcha-clientid", l)
                } else grecaptcha.reset(l);
                return grecaptcha.execute(l), !1
            }
            return window.tildaForm.send(r, t, s, i), !1
        });
        try {
            var TILDAPAGE_URL = window.location.href,
                TILDAPAGE_QUERY = "",
                TILDAPAGE_UTM = "";
            if (-1 !== TILDAPAGE_URL.toLowerCase().indexOf("utm_") && (TILDAPAGE_URL = TILDAPAGE_URL.toLowerCase(), TILDAPAGE_QUERY = TILDAPAGE_URL.split("?"), "string" == typeof(TILDAPAGE_QUERY = TILDAPAGE_QUERY[1]))) {
                var arPair, i, arParams = TILDAPAGE_QUERY.split("&");
                for (i in arParams) "utm_" == (arPair = arParams[i].split("="))[0].substring(0, 4) && (TILDAPAGE_UTM = TILDAPAGE_UTM + arParams[i] + "|||");
