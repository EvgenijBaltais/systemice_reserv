...
if ($(window).width() >= 480) {
	...
	setTimeout(function(){
		...
		if ($('#dialog').is(':hidden')) {
			...
			ym(53306992, 'reachGoal', 'get_game_click_main');
...
function goToChat(formTypeId, dopinfo) {
			...
			if (formTypeId == 'get_game_1') {
				...
				ym(53306992, 'reachGoal', 'get_game_1_main');
			}

			if (formTypeId == 'get_game_2') {

				ym(53306992, 'reachGoal', 'get_game_2_main');
			}

			if (formTypeId == 'get_game_3') {

				ym(53306992, 'reachGoal', 'get_game_3_main');
			}

			if (formTypeId == 'get_game_4') {

				ym(53306992, 'reachGoal', 'get_game_4_main');
			}
...
function resetCookie() {
	...
	$('#dialog-datepicker').datepicker({
	    ...
	    $('#step-3').fadeIn(phraseSpeed);
			...
			ym(53306992, 'reachGoal', 'get_game_1_1_main');

			ym(53306992, 'reachGoal', 'get_game_2_1_main');

			ym(53306992, 'reachGoal', 'get_game_3_1_main');

			ym(53306992, 'reachGoal', 'get_game_4_1_main');

			ym(53306992, 'reachGoal', 'get_game_click_1_main');
	...
	$('.number-button').on('click', function(){
		...
		isActive($(this));
			...
			ym(53306992, 'reachGoal', 'get_game_1_2_main');

			ym(53306992, 'reachGoal', 'get_game_2_2_main');

			ym(53306992, 'reachGoal', 'get_game_3_2_main');

			ym(53306992, 'reachGoal', 'get_game_4_2_main');

			ym(53306992, 'reachGoal', 'get_game_click_2_main');
	...
	$('.answer-button').on('click', function(){
		...
		var text = "https://api.whatsapp.com/send?phone=79096274198&text=Меня интересует: " + landingName + "; На дату: " + $('#dialog-datepicker').val() + "; Примерное кол-во человек: " + $('#step-3').find('.choosen-value').text() + "; " + already;
		...
		$('#envybox-button-onclick').attr('data-message', envyBoxText);
			...
			ym(53306992, 'reachGoal', 'get_game_1_3_main');

			ym(53306992, 'reachGoal', 'get_game_2_3_main');

			ym(53306992, 'reachGoal', 'get_game_3_3_main');

			ym(53306992, 'reachGoal', 'get_game_4_3_main');

			ym(53306992, 'reachGoal', 'get_game_click_3_main');
	...
	$('#whatsapp-button-onclick').on('click', function() {
		...
		gtag('event', 'send_form_dialog_corp', {'event_category': 'send_form_dialog_corp_'});
			...
			ym(53306992, 'reachGoal', 'get_game_1_4_main');

			ym(53306992, 'reachGoal', 'get_game_2_4_main');

			ym(53306992, 'reachGoal', 'get_game_3_4_main');

			ym(53306992, 'reachGoal', 'get_game_4_4_main');

			ym(53306992, 'reachGoal', 'get_game_click_4_main');


			ym(53306992, 'reachGoal', 'send_form_dialog_corp_main');

			ym(53306992, 'reachGoal', 'click_whatsapp_main');
	...
	$('#submit_clients_contacts').on('click', function(){
		...
		$('#step-13').fadeIn(150);
			...
			var comment = "Меня интересует: МАСТЕР-КЛАСС Эмоции и интеллект в бизнесе (systemice.ru/intellect_and_emotions/); На дату: " + $('#dialog-datepicker').val() + "; Примерное кол-во человек: " + $('#step-3').find('.choosen-value').text() + "; " + already;
...
$('.envybox').on('click', function(){

	$(this).siblings('button').removeClass('choosen-value');
