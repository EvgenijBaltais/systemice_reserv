...
if ($(window).width() >= 480) {
	...
	setTimeout(function(){
		...
		if ($('#dialog').is(':hidden')) {
			...
			ym(53306992, 'reachGoal', 'get_game_click_port');
...
function goToChat(formTypeId, dopinfo) {
			...
			if (formTypeId == 'get_game_1') {
				...
				ym(53306992, 'reachGoal', 'get_game_1_port');
			}

			if (formTypeId == 'get_game_2') {

				ym(53306992, 'reachGoal', 'get_game_2_port');
			}

			if (formTypeId == 'get_game_3') {

				ym(53306992, 'reachGoal', 'get_game_3_port');
			}

			if (formTypeId == 'get_game_4') {

				ym(53306992, 'reachGoal', 'get_game_4_port');
			}
...
function resetCookie() {
	...
	$('#dialog-datepicker').datepicker({
	    ...
	    $('#step-3').fadeIn(phraseSpeed);
			...
			ym(53306992, 'reachGoal', 'get_game_1_1_port');

			ym(53306992, 'reachGoal', 'get_game_2_1_port');

			ym(53306992, 'reachGoal', 'get_game_3_1_port');

			ym(53306992, 'reachGoal', 'get_game_4_1_port');

			ym(53306992, 'reachGoal', 'get_game_click_1_port');
	...
	$('.number-button').on('click', function(){
		...
		isActive($(this));
			...
			ym(53306992, 'reachGoal', 'get_game_1_2_port');

			ym(53306992, 'reachGoal', 'get_game_2_2_port');

			ym(53306992, 'reachGoal', 'get_game_3_2_port');

			ym(53306992, 'reachGoal', 'get_game_4_2_port');

			ym(53306992, 'reachGoal', 'get_game_click_2_port');
	...
	$('.answer-button').on('click', function(){
		...
		var text = "https://api.whatsapp.com/send?phone=79096274198&text=Меня интересует: Бизнес-игра «Порт мечты»; На дату: " + $('#dialog-datepicker').val() + "; Примерное кол-во человек: " + $('#step-3').find('.choosen-value').text() + "; " + already;
		...
		$('#envybox-button-onclick').attr('data-message', envyBoxText);
			...
			ym(53306992, 'reachGoal', 'get_game_1_3_port');

			ym(53306992, 'reachGoal', 'get_game_2_3_port');

			ym(53306992, 'reachGoal', 'get_game_3_3_port');

			ym(53306992, 'reachGoal', 'get_game_4_3_port');

			ym(53306992, 'reachGoal', 'get_game_click_3_port');
	...
	$('#whatsapp-button-onclick').on('click', function() {
		...
		gtag('event', 'send_form_dialog_corp', {'event_category': 'send_form_dialog_corp_'});
			...
			ym(53306992, 'reachGoal', 'get_game_1_4_port');

			ym(53306992, 'reachGoal', 'get_game_2_4_port');

			ym(53306992, 'reachGoal', 'get_game_3_4_port');

			ym(53306992, 'reachGoal', 'get_game_4_4_port');

			ym(53306992, 'reachGoal', 'get_game_click_4_port');


			ym(53306992, 'reachGoal', 'send_form_dialog_corp_port');

			ym(53306992, 'reachGoal', 'click_whatsapp_port');
	...
	$('#submit_clients_contacts').on('click', function(){
		...
		$('#step-13').fadeIn(150);
			...
			var comment = "Меня интересует: Бизнес-игра «Порт мечты» (systemice.ru/games/port_mechty); На дату: " + $('#dialog-datepicker').val() + "; Примерное кол-во человек: " + $('#step-3').find('.choosen-value').text() + "; " + already;
