    ...
    var steps = [], 						// Массив с id-шниками фраз менеджера и клиента, они все пронумерованы для простоты
		...
		phraseSpeed = 300,
		domain_hotel_name = "Les Art Resort",
		hotel_id = 2439,
		knight_id = 168,
		chatAlreadyOpened = 0;
...
if ($(window).width() >= 480) {
	...
	setTimeout(function(){
		...
		if ($('#dialog').is(':hidden')) {
			...
			ym(53306992, 'reachGoal', 'get_game_click_eq');
...
function goToChat(formTypeId, dopinfo) {
			...
			if (formTypeId == 'get_game_1') {
				...
				ym(53306992, 'reachGoal', 'get_game_1_eq');
			}

			if (formTypeId == 'get_game_2') {

				ym(53306992, 'reachGoal', 'get_game_2_eq');
			}

			if (formTypeId == 'get_game_3') {

				ym(53306992, 'reachGoal', 'get_game_3_eq');
			}

			if (formTypeId == 'get_game_4') {

				ym(53306992, 'reachGoal', 'get_game_4_eq');
			}
...
function resetCookie() {
	...
	$('#dialog-datepicker').datepicker({
	    ...
	    $('#step-3').fadeIn(phraseSpeed);
			...
			ym(53306992, 'reachGoal', 'get_game_1_1_eq');

			ym(53306992, 'reachGoal', 'get_game_2_1_eq');

			ym(53306992, 'reachGoal', 'get_game_3_1_eq');

			ym(53306992, 'reachGoal', 'get_game_4_1_eq');

			ym(53306992, 'reachGoal', 'get_game_click_1_eq');
	...
	$('.number-button').on('click', function(){
		...
		isActive($(this));
			...
			ym(53306992, 'reachGoal', 'get_game_1_2_eq');

			ym(53306992, 'reachGoal', 'get_game_2_2_eq');

			ym(53306992, 'reachGoal', 'get_game_3_2_eq');

			ym(53306992, 'reachGoal', 'get_game_4_2_eq');

			ym(53306992, 'reachGoal', 'get_game_click_2_eq');
	...
	$('.answer-button').on('click', function(){
		...
		var text = "https://api.whatsapp.com/send?phone=79096274198&text=Меня интересует: Бизнес-игра Эмоциональный интеллект (EQ); На дату: " + $('#dialog-datepicker').val() + "; Примерное кол-во человек: " + $('#step-3').find('.choosen-value').text() + "; " + already;
		...
		$('#envybox-button-onclick').attr('data-message', envyBoxText);
			...
			ym(53306992, 'reachGoal', 'get_game_1_3_eq');

			ym(53306992, 'reachGoal', 'get_game_2_3_eq');

			ym(53306992, 'reachGoal', 'get_game_3_3_eq');

			ym(53306992, 'reachGoal', 'get_game_4_3_eq');

			ym(53306992, 'reachGoal', 'get_game_click_3_eq');
	...
	$('#whatsapp-button-onclick').on('click', function() {
		...
		gtag('event', 'send_form_dialog_corp', {'event_category': 'send_form_dialog_corp_'});
			...
			ym(53306992, 'reachGoal', 'get_game_1_4_eq');

			ym(53306992, 'reachGoal', 'get_game_2_4_eq');

			ym(53306992, 'reachGoal', 'get_game_3_4_eq');

			ym(53306992, 'reachGoal', 'get_game_4_4_eq');

			ym(53306992, 'reachGoal', 'get_game_click_4_eq');


			ym(53306992, 'reachGoal', 'send_form_dialog_corp_eq');

			ym(53306992, 'reachGoal', 'click_whatsapp_eq');
	...
	$('#submit_clients_contacts').on('click', function(){
		...
		$('#step-13').fadeIn(150);
			...
			var comment = "Меня интересует: Бизнес-игра Эмоциональный интеллект (EQ) (systemice.ru/games/emotional_intelligence); На дату: " + $('#dialog-datepicker').val() + "; Примерное кол-во человек: " + $('#step-3').find('.choosen-value').text() + "; " + already;
