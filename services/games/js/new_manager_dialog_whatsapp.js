...
function resetCookie() {
	...
	$('#submit_clients_contacts').on('click', function(){
		...
		$('#step-13').fadeIn(150);
			...
			var comment = "Меня интересует: Бизнес-игры (Главная страница) (systemice.ru/games/); На дату: " + $('#dialog-datepicker').val() + "; Примерное кол-во человек: " + $('#step-3').find('.choosen-value').text() + "; " + already;
