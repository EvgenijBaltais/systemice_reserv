...
function resetCookie() {
	...
	$('#submit_clients_contacts').on('click', function(){
		...
		$('#step-13').fadeIn(150);
			...
			var comment = "Меня интересует: Бизнес-игра Командный талисман (systemice.ru/games/team_talisman); На дату: " + $('#dialog-datepicker').val() + "; Примерное кол-во человек: " + $('#step-3').find('.choosen-value').text() + "; " + already;
