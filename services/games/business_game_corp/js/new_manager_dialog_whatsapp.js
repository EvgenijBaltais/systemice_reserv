...
if ($(window).width() >= 480) {
	...
	setTimeout(function(){
		...
		if ($('#dialog').is(':hidden')) {
			...
			ym(53306992, 'reachGoal', 'get_game_click_corporate');
...
function goToChat(formTypeId, dopinfo) {
			...
			if (formTypeId == 'get_game_1') {
				...
				ym(53306992, 'reachGoal', 'get_game_1_corporate');
			}

			if (formTypeId == 'get_game_2') {

				ym(53306992, 'reachGoal', 'get_game_2_corporate');
			}

			if (formTypeId == 'get_game_3') {

				ym(53306992, 'reachGoal', 'get_game_3_corporate');
			}

			if (formTypeId == 'get_game_4') {

				ym(53306992, 'reachGoal', 'get_game_4_corporate');
			}
...
function resetCookie() {
	...
	$('#dialog-datepicker').datepicker({
	    ...
	    $('#step-3').fadeIn(phraseSpeed);
			...
			ym(53306992, 'reachGoal', 'get_game_1_1_corporate');

			ym(53306992, 'reachGoal', 'get_game_2_1_corporate');

			ym(53306992, 'reachGoal', 'get_game_3_1_corporate');

			ym(53306992, 'reachGoal', 'get_game_4_1_corporate');

			ym(53306992, 'reachGoal', 'get_game_click_1_corporate');
	...
	$('.number-button').on('click', function(){
		...
		isActive($(this));
			...
			ym(53306992, 'reachGoal', 'get_game_1_2_corporate');

			ym(53306992, 'reachGoal', 'get_game_2_2_corporate');

			ym(53306992, 'reachGoal', 'get_game_3_2_corporate');

			ym(53306992, 'reachGoal', 'get_game_4_2_corporate');

			ym(53306992, 'reachGoal', 'get_game_click_2_corporate');
	...
	$('.answer-button').on('click', function(){
		...
		var text = "https://api.whatsapp.com/send?phone=79096274198&text=Меня интересует: Бизнес-игра Корпорация; На дату: " + $('#dialog-datepicker').val() + "; Примерное кол-во человек: " + $('#step-3').find('.choosen-value').text() + "; " + already;
		...
		$('#envybox-button-onclick').attr('data-message', envyBoxText);
			...
			ym(53306992, 'reachGoal', 'get_game_1_3_corporate');

			ym(53306992, 'reachGoal', 'get_game_2_3_corporate');

			ym(53306992, 'reachGoal', 'get_game_3_3_corporate');

			ym(53306992, 'reachGoal', 'get_game_4_3_corporate');

			ym(53306992, 'reachGoal', 'get_game_click_3_corporate');
	...
	$('#whatsapp-button-onclick').on('click', function() {
		...
		gtag('event', 'send_form_dialog_corp', {'event_category': 'send_form_dialog_corp_'});
			...
			ym(53306992, 'reachGoal', 'get_game_1_4_corporate');

			ym(53306992, 'reachGoal', 'get_game_2_4_corporate');

			ym(53306992, 'reachGoal', 'get_game_3_4_corporate');

			ym(53306992, 'reachGoal', 'get_game_4_4_corporate');

			ym(53306992, 'reachGoal', 'get_game_click_4_corporate');


			ym(53306992, 'reachGoal', 'send_form_dialog_corp_corporate');

			ym(53306992, 'reachGoal', 'click_whatsapp_corporate');
	...
	$('#submit_clients_contacts').on('click', function(){
		...
		$('#step-13').fadeIn(150);
			...
			var comment = "Меня интересует: Бизнес-игра Корпорация (systemice.ru/games/business_game_corp); На дату: " + $('#dialog-datepicker').val() + "; Примерное кол-во человек: " + $('#step-3').find('.choosen-value').text() + "; " + already;
