...
function resetCookie() {
	...
	$('.answer-button').on('click', function(){
		...
		var text = "https://api.whatsapp.com/send?phone=79096274198&text=Меня интересует: Бизнес-игра Командный талисман; На дату: " + $('#dialog-datepicker').val() + "; Примерное кол-во человек: " + $('#step-3').find('.choosen-value').text() + "; " + already;
	...
	$('#submit_clients_contacts').on('click', function(){
		...
		$('#step-13').fadeIn(150);
			...
			var comment = "Меня интересует: Бизнес-игра Командный Тайм-менеджмент (systemice.ru/games/eam_time_management); На дату: " + $('#dialog-datepicker').val() + "; Примерное кол-во человек: " + $('#step-3').find('.choosen-value').text() + "; " + already;
